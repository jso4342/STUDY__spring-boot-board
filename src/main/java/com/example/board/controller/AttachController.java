...
public class AttachController {
    ...
    public List<AttachVO> uploadAjaxPost(MultipartFile[] uploadFile){
        String uploadFolder = "/Users/macintoshhd/Desktop/upload";
...
//    }
    ...
    public ResponseEntity<Resource> download(String fileName){
        Resource resource = new FileSystemResource("/Users/macintoshhd/Desktop/upload/" + fileName);
        HttpHeaders header = new HttpHeaders();
...
//        브라우저에 다운로드 될 파일의 저장 정보를 설정한다.
    ...
    public String deleteFile(String fileName, String type){
        File file = new File("/Users/macintoshhd/Desktop/upload/" + fileName);
        file.delete();
