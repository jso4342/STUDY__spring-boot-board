...
public class BoardServiceTests {
    ...
    public void testGetList(){
        boardService.getList(new Criteria(1, 10, "TCW", "안녕")).forEach(board -> log.info(board.toString()));
      //  boardService.getList(new Criteria(4, 10, "TC", "안녕")).forEach(board -> log.info(board.toString()));
    }
}
